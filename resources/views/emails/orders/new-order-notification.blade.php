                                        ...
                                        <tbody>
                                            <tr>
                                                <p style="text-align: center;">Hello
                                                    {{ $order->product->owner->$role->contact_person }}. A new order has
                                                    just been
                                                    placed for one of your products on the FarmKonnect Sellers App. The
                                                    details of the order have been listed below. Kindly login to your
                                                    account to view and respond to this order.</p>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <div style="text-align: left;">
                                                    <ul>
                                                        <li>{{  $order->quantity_ordered.' '.$order->unit->unit_name.'(s)' }}
                                                            of
