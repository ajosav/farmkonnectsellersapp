                                        ...
                                        <tbody>
                                            <tr>
                                                <p style="text-align: center;">Hello
                                                    {{ $order->user->name }}. The products in your request for delivery
                                                    from
                                                    {{ $logistic_company->name }} on the Farmkonnect Sellers App have
                                                    just been picked up. The details of the request are below. Please
                                                ...
                                                <div style="text-align: left;">
                                                    <ul>
                                                        <ol>Delivery of
                                                            ...
                                                            <b>{{ $delivery->distance.'KM' }}</b> in distance.</b>
                                                        </ol>
                                                    </ul>
                                                </div>
                                            </tr>
