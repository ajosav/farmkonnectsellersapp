                                        ...
                                        <tbody>
                                            <tr>
                                                <p style="text-align: center;">Hello
                                                    {{ $logistic_company->name }}. Your delivery on Farmkonnect Seller's
                                                    app has just been confirmed by the buyer and the fee has been
                                                    deposited into your wallet. Thank you for using Seller's App
                                                </p>
                                            </tr>
                                        </tbody>
                                    </table>
