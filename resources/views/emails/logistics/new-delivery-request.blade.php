                                        ...
                                        <tbody>
                                            <tr>
                                                <p style="text-align: center;">Hello
                                                    {{ $logistic_company->name }}. A new request has
                                                    just been
                                                    made for your delivery services on the Farmkonnect Sellers App. The
                                                    details of this request are
                                                    listed below. Kindly login to your
                                                    account to view and respond to this request.
                                                </p>
                                            </tr>
                                        </tbody>
                                    </table>
                                                ...
                                                <div style="text-align: left;">
                                                    <ul>
                                                        <ol>Delivery of
                                                            ...
                                                            your specified rate, the fee for the delivery would be
                                                            <b>&#8358;{{ $delivery->fee }}</b>
                                                        </ol>
                                                    </ul>
                                                </div>
