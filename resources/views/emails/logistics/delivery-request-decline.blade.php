                                        ...
                                        <tbody>
                                            <tr>
                                                <p style="text-align: center;">Hello
                                                    {{ $order->user->name }}. Your request for delivery services from
                                                    {{ $logistic_company->name }} on the Farmkonnect Sellers App has
                                                    just been rejected and the delivery fee returned to your wallet. The
                                                    details of the request are below. Please
