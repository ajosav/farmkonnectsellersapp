<div class="btn-group">
    ...
    <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu" x-placement="top-end"
        style="position: absolute; transform: translate3d(-76px, -144px, 0px); top: 0px; left: 0px; will-change: transform;">
        <li>
            <button type="button" class="btn btn-link view" data-toggle="modal" data-target="#product-{{$uuid}}"><i
        ...
        <form action="{{ route('product.destroy', $uuid) }}" method="POST">
            ...
            <li>
                <button type="submit" class="btn btn-link text-danger" onclick="return confirm('Are you sure?')"><i
                        ...
                        <div class="col-12 col-sm-6">
                            <div id="carouselExampleIndicators-{{$id}}" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    ...
                                    <li data-target="#carouselExampleIndicators-{{$id}}" data-slide-to="{{$index}}"
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item {{$index == 0 ? 'active' : ''}}">
                                        <img class="d-block w-100"
                                            src="{{$model->product_image('products/large/'.$p_img)}}"
                                            alt="Product Image">
                                    </div>
                                    @endforeach
                                ...
                                <a class="carousel-control-prev" href="#carouselExampleIndicators-{{$id}}" role="button"
                                    data-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="sr-only">Previous</span>
                                </a>
                                <a class="carousel-control-next" href="#carouselExampleIndicators-{{$id}}" role="button"
                                    data-slide="next">
